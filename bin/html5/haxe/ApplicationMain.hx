...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TestTaskHaxeUI", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TestTaskHaxeUI", null, 520, 550);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "5";
		app.meta["company"] = "OleksandraFilistovich";
		app.meta["file"] = "TestTaskHaxeUI";
		app.meta["name"] = "TestTask_HaxeUI";
		app.meta["packageName"] = "TestTaskHaxeUI";
		...
		#elseif !air
		app.window.context.attributes.background = 14540253;
